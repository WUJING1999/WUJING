import cv2
import numpy as np
from KSC_proto_new3d_test_4layer_band50 import ProtoNetwork, test
...
from KSC_data_loaderBS import KSC
...
if __name__ == '__main__':
    seed_everything()
    width, height, channel = 11, 11, 45
    zgff = KSC(width)
    name = "ksc-band45-3layerbaseline"
    ...
    save_path = './model/KSC/KC_proto_3d-5shotband45layer3-64output.pth'.format(n_way, n_shot)
    ...
    plt.savefig('./map/{}_confusion_matrixband2D-band45-IP.png'.format(name))