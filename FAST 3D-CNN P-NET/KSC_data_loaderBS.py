...
class KSC():
    ...
    def get_patch(self, index, p=11):
        ...
        selected = [56, 18, 132, 60, 175, 173, 27, 89, 170, 174, 0, 48, 169, 172, 83, 131, 167, 171,
                     32, 168, 133, 73, 31, 166, 163, 96, 165, 159, 161, 164, 45,  2, 41, 160, 162, 6, 3,
                     139, 97, 127, 103, 138, 101, 117, 1, ]
    ...
    def getPatches(self, indexes):
        patchData = np.zeros([len(indexes), self.windowSize, self.windowSize, 45], dtype=np.float32)
        selected = [56, 18, 132, 60, 175, 173, 27, 89, 170, 174, 0, 48, 169, 172, 83, 131, 167, 171,
                     32, 168, 133, 73, 31, 166, 163, 96, 165, 159, 161, 164, 45,  2, 41, 160, 162, 6, 3,
                     139, 97, 127, 103, 138, 101, 117, 1, ]
