...
class KSC():
    ...
    def get_patch(self, index, p=11):
        ...
        selected = [ 56, 72, 18, 173, 175, 27, 132, 174, 170, 48, 0, 169, 172, 131, 167, 171, 168, 32,
                     2, 163, 133, 166, 165, 161, 159, 162, 73, 96, 160, 60, 164,  31, 41, 8, 42, ]
    ...
    def getPatches(self, indexes):
        patchData = np.zeros([len(indexes), self.windowSize, self.windowSize, 35], dtype=np.float32)
        selected = [ 56, 72, 18, 173, 175, 27, 132, 174, 170, 48, 0, 169, 172, 131, 167, 171, 168, 32,
                     2, 163, 133, 166, 165, 161, 159, 162, 73, 96, 160, 60, 164,  31, 41, 8, 42, ]
