...
class KSC():
    ...
    def get_patch(self, index, p=11):
        ...
        selected =[45, 75, 70, 16, 31, 173, 132, 175, 174, 170, 83, 0, 169, 172, 167, 131, 171, 168, 133,
                    163, 166, 2, 165, 27, 159, 162, 164, 160, 161, 96, 139, 44, 33, 104,
                    142, 106, 140, 105, 138, 102, 85, 98, 73, 114, 117, 101, 100, 158, 135, 156, 97, 150, 41, 123, 42, ]
    ...
    def getPatches(self, indexes):
        patchData = np.zeros([len(indexes), self.windowSize, self.windowSize, 55], dtype=np.float32)
        selected = [45, 75, 70, 16, 31, 173, 132, 175, 174, 170, 83, 0, 169, 172, 167, 131, 171, 168, 133,
                    163, 166, 2, 165, 27, 159, 162, 164, 160, 161, 96, 139, 44, 33, 104,
                    142, 106, 140, 105, 138, 102, 85, 98, 73, 114, 117, 101, 100, 158, 135, 156, 97, 150, 41, 123, 42, ]
