import cv2
import numpy as np
from KSC_proto_new3d_train_4layer_band45 import ProtoNetwork, test
...
from KSC_data_loaderBS import IndianPines
...
if __name__ == '__main__':
    ...
    save_path = './model/IP/IP_proto_3d-5shotband45layer3-64output.pth'.format(n_way, n_shot)
