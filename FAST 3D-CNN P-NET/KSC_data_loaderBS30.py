...
class KSC():
    ...
    def get_patch(self, index, p=11):
        ...
        selected = [56, 83, 19, 132, 173, 175, 48, 174, 0, 31, 170, 169, 172, 27, 171, 167, 131, 2, 163, 133, 168,
                    73, 96, 36, 166, 30, 165, 41, 159, 160, ]
    ...
    def getPatches(self, indexes):
        patchData = np.zeros([len(indexes), self.windowSize, self.windowSize, 30], dtype=np.float32)
        selected = [56, 83, 19, 132, 173, 175, 48, 174, 0, 31, 170, 169, 172, 27, 171, 167, 131, 2, 163, 133, 168,
                    73, 96, 36, 166, 30, 165, 41, 159, 160, ]
