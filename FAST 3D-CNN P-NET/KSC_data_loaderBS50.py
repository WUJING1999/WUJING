...
class KSC():
    ...
    def get_patch(self, index, p=11):
        ...
        selected = [43, 56, 68, 75, 31, 18, 132, 173, 175, 6, 83, 174, 170, 169, 172, 167, 72, 131, 2, 76, 27, 168,
                     153, 166, 163, 165, 159, 161, 96, 162, 42, 164, 12, 168, 139, 171, 162, 41, 150, 104,
                     134, 40, 44, 156, 158, 97, 149, 103, 142, 141, ]
